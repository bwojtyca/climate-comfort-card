  ...
  `,t([mt({attribute:!1})],de.prototype,"hass",void 0),t([ft()],de.prototype,"_config",void 0),de=t([ht("climate-comfort-card-editor")],de),console.info("%c CLIMATE-COMFORT-CARD %c v0.2.0-beta.7 ","color: white; background: #2e9e5b; font-weight: 700;","color: #2e9e5b; background: white; font-weight: 700;"),window.customCards=window.customCards||[],window.customCards.push({type:gt,name:se("card.name"),description:se("card.description"),preview:!0});let pe=class extends lt{constructor(){super(...arguments),this._hovered=null,this._hidden=new Set,this._hoveredGroup=null,this._trails={},this._trailCache=new Map,this._trailInflight=new Set}static async getConfigElement(){return document.createElement(`${gt}-editor`)}static getStubConfig(){return{type:`custom:${gt}`,title:"Comfort",preset:"living_room",points:[]}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={zone_mode:"auto",zone_display:"always",show_legend:!0,mold_risk:!0,trail_display:"hover",trail_hours:24,...t,points:t.points??[]},this._trails={},this._trailCache.clear(),this._hidden=new Set,this._hoveredGroup=null}getCardSize(){return 6}get _lang(){return this.hass?.language??"en"}_t(t){return se(t,this._lang)}_resolvePoints(){return this._config&&this.hass?this._config.points.map(t=>{const e=zt(t,this._config.preset),i=t.temperature?jt(this.hass.states[t.temperature]?.state):void 0,o=t.humidity?jt(this.hass.states[t.humidity]?.state):void 0,r=Dt({name:t.name||this._entityFallbackName(t),profile:e,temperature:i,humidity:o});return{config:t,profile:e,evaluation:r,color:t.color??(r.unavailable?"var(--disabled-text-color, #9e9e9e)":Jt(r.score))}}):[]}_entityFallbackName(t){const e=t.temperature||t.humidity;return e&&this.hass?.states[e]?this.hass.states[e].attributes.friendly_name??e:e??"-"}_overallLabel(t){if(t.unavailable)return this._t("card.unavailable");const e=[];for(const i of[t.temperature,t.humidity,t.dewPoint])if(i&&"comfortable"!==i.status){const t=this._t(Bt(i));e.includes(t)||e.push(t)}return e.length?e.join(", "):this._t("status.comfortable")}get _trailHours(){return this._config?.trail_hours??24}get _prefersReducedMotion(){return window.matchMedia?.("(prefers-reduced-motion: reduce)").matches??!1}_neededTrailIndices(t){const e=this._config?.trail_display??"hover";if("off"===e)return[];const i=t=>{const e=this._config.points[t];return!(!e?.temperature||!e?.humidity||this._hidden.has(t))};return"all"===e?t.map((t,e)=>e).filter(i):null!==this._hovered&&i(this._hovered)?[this._hovered]:[]}_ensureTrails(t){const e=this._trailHours;for(const i of t){const t=`${i}|${e}`;if(this._trails[i]||this._trailInflight.has(t))continue;const o=this._trailCache.get(t);o&&Date.now()-o.at<12e4?this._trails={...this._trails,[i]:o.points}:this._loadTrail(i,e,t)}}async _loadTrail(t,e,i){const o=this._config?.points[t];if(!o?.temperature||!o.humidity||!this.hass)return;this._trailInflight.add(i);const r=new Date,s=new Date(r.getTime()-36e5*e);try{const e=await this.hass.callWS({type:"history/history_during_period",start_time:s.toISOString(),end_time:r.toISOString(),entity_ids:[o.temperature,o.humidity],minimal_response:!0,no_attributes:!0}),n=function(t,e,i,o){const r=(o-i)/40,s=[];let n,a,c=0,l=0;for(let o=0;o<=40;o++){const d=i+r*o;for(;c<t.length&&t[c].ms<=d;)n=t[c++].v;for(;l<e.length&&e[l].ms<=d;)a=e[l++].v;if(void 0===n||void 0===a)continue;const h=s[s.length-1];h&&h.t===n&&h.h===a||s.push({t:n,h:a})}return s}(he(e[o.temperature]),he(e[o.humidity]),s.getTime(),r.getTime());this._trailCache.set(i,{points:n,at:Date.now()}),this._trails={...this._trails,[t]:n}}catch{}finally{this._trailInflight.delete(i)}}shouldUpdate(t){if(t.has("_config")||t.has("_hovered")||t.has("_trails")||t.has("_hidden")||t.has("_hoveredGroup"))return!0;if(!this._config)return!1;const e=t.get("hass");return!e||this._config.points.some(t=>[t.temperature,t.humidity].some(t=>t&&e.states[t]!==this.hass.states[t]))}render(){if(!this._config||!this.hass)return W;const t=this._resolvePoints(),{tempAxis:e,humAxis:i}=this._computeAxes(t),o=t.map((t,e)=>{const{evaluation:i}=t;if(i.unavailable||this._hidden.has(e))return null;const o=void 0!==i.temperature,r=void 0!==i.humidity,s=o&&r?"none":o?"x-axis":"y-axis";return{index:e,eval:i,color:t.color,pin:s}}).filter(t=>null!==t),r=null!==this._hovered?t[this._hovered]:void 0,s=this._zones(t,r),n=this._neededTrailIndices(t);this._ensureTrails(n);const a=n.filter(t=>this._trails[t]?.length>1).map(e=>({points:this._trails[e],color:t[e].color}));return F`
    ...
    >
      ...
      ${e.map(e=>{const o=i.get(e),r=o.filter(t=>!this._hidden.has(t)).length;return F`<div class="ccc-group">
          ...
          ${o.map(e=>this._renderBadge(t[e],e))}
        </div>`})}
    </div>`}};pe.styles=n`
    ha-card {
      overflow: hidden;
