...
const EN: Dict = {
  ...
  'editor.custom_presets': 'Custom presets',
  'editor.add_custom_preset': 'Add custom preset',
  'editor.preset_name': 'Preset name',
  ...
  'editor.custom_temp': 'Temperature (°C)',
  'editor.custom_hum': 'Humidity (%)',
  'editor.custom_dew': 'Dew point (°C)',
  'editor.pref_min': 'Preferred min',
  'editor.pref_max': 'Preferred max',
  'editor.acc_min': 'Acceptable min',
  'editor.acc_max': 'Acceptable max',
...
const PL: Dict = {
  ...
  'editor.custom_presets': 'Własne presety',
  'editor.add_custom_preset': 'Dodaj własny preset',
  'editor.preset_name': 'Nazwa presetu',
  ...
  'editor.custom_temp': 'Temperatura (°C)',
  'editor.custom_hum': 'Wilgotność (%)',
  'editor.custom_dew': 'Punkt rosy (°C)',
  'editor.pref_min': 'Preferowana od',
  'editor.pref_max': 'Preferowana do',
  'editor.acc_min': 'Akceptowalna od',
  'editor.acc_max': 'Akceptowalna do',
